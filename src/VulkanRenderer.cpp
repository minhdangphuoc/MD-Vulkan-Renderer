...
void VulkanRenderer::createTextureImage()
{
    ...
    stbi_uc* pixels = stbi_load("D:/MD-Vulkan-Renderer/textures/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
							...
							VkDeviceMemory& imageMemory)
{
	...
	if (vkCreateImage(mainDevice.logicalDevice, &imageInfo, nullptr, &textureImage) != VK_SUCCESS) {
    	throw std::runtime_error("failed to create image!");
	}

	VkMemoryRequirements memRequirements;
	vkGetImageMemoryRequirements(mainDevice.logicalDevice, textureImage, &memRequirements);
